...
class Database {
	constructor() {
		...
		this.databaseOptions = {
			...
			minifyAliases: true,
			query: {
				raw: true, //apenas recebo dados puros 
			},
		};

		this._instance = new Sequelize( //representa a conexão com o banco
	...
	connect() {
		this._loadModels(); //carrega os models
		this._instantiateModels(); //cria as associações entre os models
